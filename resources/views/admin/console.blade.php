    ...
    <div class="main-panel">
        ...
        <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2017-2018 <a href="//www.linxiaobei.cn/" target="_blank">xiaobei blog</a>. All rights reserved. </span>
            </div>
        </footer>
        <!-- partial -->
    </div>
