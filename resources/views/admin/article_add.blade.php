                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" id="form">
                                <div class="form-group">
                                    <label >* 文章标题</label>
                                    <input type="text"  class="form-control required" name="title" placeholder="文章标题">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    {{--<select class="form-control required" id="tags" name="tags">--}}
                                    ...
                                    <br>
                                    @foreach($tagsList as $k=>$v)
                                        <label style="margin-left: 15px;"><input type="checkbox" id="tags" name="tags[]"
                                                      value="{{$v->id}}" />{{$v->name }}</label>
                                    @endforeach
                                </div>
                                ...
                                <div class="form-group " id="text">
                                    ...
                                    {{--<textarea  placeholder="请在此处编辑内容" class="required" name="content" id="editor"--}}
                                               {{--style="height:400px;--}}
                                    {{--max-height:400px;overflow: hidden"></textarea >--}}
                                    <div id="editormd">
                                    <textarea placeholder="请在此处编辑内容" class="required" name="content" style="display:none;"></textarea>
                                     </div>
